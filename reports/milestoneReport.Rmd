...
#change for this:
# set.seed(123)
# lineSelection <- sample(as.integer(filesSize_df[3,3]), 5000)

con <- file(paste(mywd, "/reports/final/en_US/en_US.twitter.txt", sep=""), 
            "r")

# enDataSubset <- readLines(con, skipNul = TRUE)[lineSelection]
# close(con)
