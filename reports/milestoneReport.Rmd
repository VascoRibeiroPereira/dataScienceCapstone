...
This work will focus primarily in the `en_US.twitter.txt`. This data have `r filesSize_df[3,3]` entries, which means that there's a lot of data to work with and may be impractical to import the complete file to perform data analysis due to memory limitations.
...
The subset of the data was randomly selected with a `sample` function in relation to the chosen percentage of the number of entries. 
...
Graphical representation of the unigram frequency with the most frequent unigrams (>=300 occurrences) and its respective wordcloud with the 50 most frequent words.
...
Graphical representation of the bigram frequency with the most frequent unigrams (>=80 occurrences) and its respective wordcloud with the 50 most frequent words.
...
Graphical representation of the trigram frequency with the most frequent unigrams (>=15 occurrences) and its respective wordcloud with the 40 most frequent words.
...
Graphical representation of the tetragram frequency with the most frequent unigrams (>=5 occurrences) and its respective wordcloud with the 40 most frequent words.
